...
class MainActivity : AppCompatActivity() {
    ...
    private fun sendNotification() {
        ...
        val builder = NotificationCompat.Builder(this,CHANNEL_ID)
            ...
            .setContentTitle("notification ariel")
            .setContentText("Nezy Mutu monene")
            .setLargeIcon(bitmapLargeIcon)
           .setStyle(NotificationCompat.BigTextStyle().bigText("Much longer text cannot display please click on it nezy"))
