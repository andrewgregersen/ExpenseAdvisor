...
//        }
        ...
        Binding.SubmitMan.setOnClickListener {
            ...
            when {
                ...
                else -> alertDialog(mAdapter.mData as ArrayList<DatabaseHelper.Item>) //items in recycler view are not empty
    ...
    private fun alertDialog(list: ArrayList<DatabaseHelper.Item>) {
    ...
    private fun submitItems(list: ArrayList<DatabaseHelper.Item>) {
    ...
    inner class MyAdapter(
        val mData: MutableList<DatabaseHelper.Item>,
        val iName: EditText,
         ...
         */
        fun addItem(item: DatabaseHelper.Item) {
    ...
    companion object : DiffUtil.ItemCallback<DatabaseHelper.Item>() {
        override fun areItemsTheSame(oldItem: DatabaseHelper.Item, newItem: DatabaseHelper.Item): Boolean {
            return oldItem == newItem
        }

        override fun areContentsTheSame(oldItem: DatabaseHelper.Item, newItem: DatabaseHelper.Item): Boolean {
