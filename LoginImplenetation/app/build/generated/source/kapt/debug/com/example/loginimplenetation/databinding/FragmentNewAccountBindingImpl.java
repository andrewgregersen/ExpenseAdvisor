...
public class FragmentNewAccountBindingImpl extends FragmentNewAccountBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.goBack, 1);
        sViewsWithIds.put(R.id.createUser, 2);
        sViewsWithIds.put(R.id.createPass1, 3);
        sViewsWithIds.put(R.id.createPass2, 4);
        sViewsWithIds.put(R.id.submit_button, 5);
    }
    // views
    @NonNull
