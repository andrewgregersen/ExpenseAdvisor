...
public class LoggedActivityBindingImpl extends LoggedActivityBinding  {
    ...
    public LoggedActivityBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }
    private LoggedActivityBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.settingsDrawer.setTag(null);
        setRootTag(root);
        // listeners
        invalidateAll();
    }
