...
class LaundryItem : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        titlesList = db.getItemsOfCategory("Laundry")
        descList= db.getOnlyPriceOfItemOfCategory("Laundry")
