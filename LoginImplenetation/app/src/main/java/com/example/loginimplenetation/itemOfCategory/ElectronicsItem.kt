...
class ElectronicsItem : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        titlesList = db.getItemsOfCategory("Electronics")
        descList= db.getOnlyPriceOfItemOfCategory("Electronics")
    ...
    private fun postToList(x: Int){
        for(i in 1..x){
            addToList(R.drawable.electronics)
        }
    }
}