...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        divSpinner = (Spinner) findViewById(R.id.divSpinner2);
                ...
                switch (selectedClass)
                {
                    case "Class 1":
                        ...
                        divSpinner.setAdapter(new ArrayAdapter<String>(MainActivity.this,
                                ...
                                getResources().getStringArray(R.array.array_data)));
                        break;

                    case "Class 2":
                        divSpinner.setAdapter(new ArrayAdapter<String>(MainActivity.this,
                                android.R.layout.simple_spinner_dropdown_item,
                                getResources().getStringArray(R.array.array_data2)));
                        break;

                    case "Class 3":
                        divSpinner.setAdapter(new ArrayAdapter<String>(MainActivity.this,
                                android.R.layout.simple_spinner_dropdown_item,
                                getResources().getStringArray(R.array.array_data3)));
                        break;
